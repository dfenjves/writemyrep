class LetterBuilder
  attr_reader :representative, :from, :user_name, :user_address,:user_phone, :user_email, :support_or_opposition, :issue, :who_am_i, :affected_parties, :primary_concern, :details, :outcome
